...
void MainWindow::createToolbars() {
    ...
    offsetLabel = new QLabel("View Offset");
    settingToolBar->addWidget(offsetLabel);
    
    viewOffset = new QSpinBox(this);
    viewOffset->setButtonSymbols(QAbstractSpinBox::NoButtons);
    settingToolBar->addWidget(viewOffset);
    showOffset(syncCheckBox->checkState());
}
...
void MainWindow::createStatusBar() {
    /*************************************************************
     * 
     * The following code is commented out, not because it is 
     * useless, but because it implements unused, and probably, 
     * unusable functionality; Never-the-less, this should be 
     * connected to a signal on a child object of MainWindow, and, 
...
void MainWindow::showOffset(Qt::CheckState checked){
    if(! checked) {
        viewOffset->show();
        offsetLabel->show();
    }
